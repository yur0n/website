...
export default async (req, res) => {
    axios.get(`https://oauth.vk.com/access_token?client_id=51504694&client_secret=dPIjYcxdyMO29LuCjOdZ&redirect_uri=https://yuron.xyz/api/tg&code=${req.query.code}`)
    .then(async(data) => {
